...
let AboutTBUpdateListener = {
  ...
  getChangeLogText: function() {
    try {
      ...
      // Browser/ or, on Mac OS, JonDoBrowser.app/Contents/MacOS/.
      let f = Services.dirsvc.get("XREExeF", Ci.nsIFile).parent;
#ifdef XP_MACOSX
      f = f.parent;
      f.append("Resources");
#endif
      f.append("JonDoBrowser");
#else
      // "DefProfRt" is .../JonDoBrowser/Data/Browser
