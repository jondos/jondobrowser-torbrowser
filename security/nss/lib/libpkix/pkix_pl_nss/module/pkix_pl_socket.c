...
#if 1
        printf("JonDoBrowser BUG: Attempted pkix direct socket connect\n");
        PKIX_ERROR(PKIX_PRNEWTCPSOCKETFAILED);
#endif
        ...
        void *plContext)
{
        ...
        // we want to ensure nothing can ever hit this code in production.
#if 1
        printf("JonDoBrowser BUG: Attempted pkix direct connect to %s\n", serverName);
        PKIX_ERROR(PKIX_PRNEWTCPSOCKETFAILED);
#endif
        ...
        void *plContext)
{
        ...
        // we want to ensure nothing can ever hit this code in production.
#if 1
        printf("JonDoBrowser BUG: Attempted pkix direct connect to %s, port %u\n", hostname,
                portnum);
        PKIX_ERROR(PKIX_PRNEWTCPSOCKETFAILED);
#endif
